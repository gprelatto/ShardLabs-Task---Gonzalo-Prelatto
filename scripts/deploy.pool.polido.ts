...
const YBT_NAME = "PoLido staked MATIC";
const YBT_SYMBOL = "stMATIC";
const CONTRACT_NAME = "PoLidoTempusPool";
...
async function deploy() {
  ...
  const polido = await utils.promptAddress("Enter the address of the PoLido contract", (await utils.getDeployedContractAddress(network.name, 'PoLido')));
  ...
  const referrer = await utils.promptAddress("Enter the address of the PoLido Referrer");
