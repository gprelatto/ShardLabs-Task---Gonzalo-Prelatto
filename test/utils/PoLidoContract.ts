...
export abstract class PoLidoContract extends ERC20 {
  asset:ERC20Ether; // ERC20 Ether Wrapper (not WETH!)
  yieldToken:ERC20; // stMATIC

  constructor(contractName:string, pool:Contract, asset:ERC20Ether) {
    super(contractName, asset.decimals, pool);
    this.asset = asset;
    this.yieldToken = this; // for PoLido, the pool itself is the Yield Token
  }

  /** @return stMATIC balance of an user */
  ...
  /** @return total stMATIC shares minted */
